...
#region Unity Messages
	...
	{
		Vector3 euler = RotationAnchor.rotation.eulerAngles;

		float rotateInfluence = Time.deltaTime * RotationSpeed;
		...
		transform.RotateAround(RotationAnchor.position, RotationAnchor.up, secondaryAxis.x * rotateInfluence);
	}
}
